...
func internalTemplatedataBindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/templatedata/bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1538695630, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func internalTemplatedataServerTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/templatedata/server.tmpl", size: 1895, mode: os.FileMode(420), modTime: time.Unix(1538695625, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func internalTemplatedataServer_implTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/templatedata/server_impl.tmpl", size: 1571, mode: os.FileMode(420), modTime: time.Unix(1538695559, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
